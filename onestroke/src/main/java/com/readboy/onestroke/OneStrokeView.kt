...
class OneStrokeView @JvmOverloads constructor(
    ...
    private var finishedLister: OnFinishedLister? = null
    fun setListener(listener: OnFinishedLister) {
        this.finishedLister = listener
    }
