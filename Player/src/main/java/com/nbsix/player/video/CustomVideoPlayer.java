...
import com.nbsix.player.PreViewManager;
...
public class CustomVideoPlayer extends StandardVideoPlayer {
    ...
    private MyTextureView mPreviewTexture;
    ...
    protected void addTextureView() {
        ...
        mPreviewTexture = new MyTextureView(getContext());
        mPreviewTexture.setSurfaceTextureListener(new MyTextureView.SurfaceTextureListener() {
            @Override
    ...
    public BaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        CustomVideoPlayer customVideoPlayer = (CustomVideoPlayer) baseVideoPlayer;
