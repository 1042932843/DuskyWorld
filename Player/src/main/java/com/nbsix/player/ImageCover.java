...
import com.nbsix.player.utils.VideoType;

@SuppressLint("AppCompatCustomView")
public class ImageCover extends ImageView {
    ...
    public ImageCover(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public ImageCover(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        fullView = (VideoType.getShowType() == VideoType.SCREEN_TYPE_FULL);
