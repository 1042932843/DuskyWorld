...
import com.dusky.duskyplayer.video.VideoType;
...
public class VideoManager implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnCompletionListener,
    ...
    private WeakReference<VideoPlayerListener> listener;
    private WeakReference<VideoPlayerListener> lastListener;
    ...
    public VideoPlayerListener lastListener() {
    ...
    public void setLastListener(VideoPlayerListener lastListener) {
        if (lastListener == null)
