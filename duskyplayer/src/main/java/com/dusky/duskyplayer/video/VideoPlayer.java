...
public abstract class VideoPlayer extends BaseVideoPlayer implements View.OnClickListener, View.OnTouchListener, SeekBar.OnSeekBarChangeListener, TextureView.SurfaceTextureListener {
     ...
     */
    public VideoPlayer(Context context, IjkLibLoader ijkLibLoader) {
        super(context);
    ...
    protected void addTextureView() {
        ...
        mMyTextureView.setRotation(mRotate);
    ...
    public void setRotationView(int rotate) {
        this.mRotate = rotate;
        mMyTextureView.setRotation(rotate);
    }

    public void refreshVideo() {
        if (mMyTextureView != null) {
        ...
        if (id == R.id.surface_container) {
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (mChangePosition && VideoManager.instance().getMediaPlayer() != null) {
    ...
    protected void showPauseCover() {
        try {
            if (mCurrentState == CURRENT_STATE_PAUSE && mFullPauseBitmap != null
                ...
                mCoverImageView.setRotation(mMyTextureView.getRotation());
